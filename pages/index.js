			...
			<main className={styles.main}>
				...
				<header className={headerStyles.header}>
					...
					<nav className={headerStyles.nav}>
						...
						{/* </div> */}
						<a
							href="https://mintysolutions.com/contact"
							className={headerStyles.scheduleACallBtnContainer}>
							<button
					...
					<div className={headerStyles.heroContent}>
						...
						<div className={headerStyles.headerBtns}>
							...
							<a href="https://mintysolutions.com/contact">
				...
				<div className={styles.metricsSection}>
					...
					<div className={styles.metrics}>
						...
						<div className={styles.metricsCard}>
							...
							<p>
								<CountUp end={823} redraw={true} duration={4.5}>
									{({ countUpRef, start }) => (
										<VisibilitySensor onChange={start} delayedCall>
											<span ref={countUpRef} />
										</VisibilitySensor>
						...
						<div className={styles.metricsCard}>
							...
							<p>
								<CountUp start={0} end={1130000} separator="," redraw={true}>
									{({ countUpRef, start }) => (
										<VisibilitySensor onChange={start} delayedCall>
											<span ref={countUpRef} />
										</VisibilitySensor>
				...
				<div className={styles.servicesOne}>
					<div style={{ padding: "25px" }}>
						...
						<p
							...
							Want your own personalized team of creative experts?
						</p>
					...
					<div className={styles.growYourProjectImg}>
						<Image src="/images/01-min.png" width={514} height={372} alt={""} />
					</div>
				</div>
				...
				<div className={styles.pricingCards}>
					...
					<div className={styles.pricingCardsItem}>
						...
						<h2>
							$750<span className={styles.perMonth}>/month</span>
						</h2>
						<hr />
						<div className={styles.content}>
							<div>
